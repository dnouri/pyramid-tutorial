...
class Registration(FormView):
    ...
    def register_success(self, appstruct):
        ...
        # You should add an '__acl__' attribute to your user object,
        # in order to grant users the 'add', 'edit' and 'share'
        # permissions in their own folders.

        # Note that we have so far not made use of the 'share'
        # permission, but they idea is that users with the 'share'
        # permission will be able to grant other users the 'add' and
        # 'edit' permissions.
